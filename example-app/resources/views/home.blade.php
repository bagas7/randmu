		...
		<div class="container d-flex align-items-center">
			...
			<nav id="navbar" class="navbar">
				<ul>
					...
					<li><a class="nav-link" href="contact"><button type="button" class="btn-get-started">Login</button></a></li>
				</ul>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
					<h1>Quality Service With Better Insight</h1>
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row content">
					<div class="col" style="text-align: center;">
						<p>
							<strong>Randmu</strong> is consulting firm with its origin in Indonesia.
							It is an all-encompassing business consultancy, providing services & consultancy in the different business fields
							to assist organizations to outperform in the challenging market place; 
							audit & assurance, tax, finance& accountancy, as well as HR & feasibility studies. <br><br>
				...
				<div class="row">
					...
					<div class="col-lg-8 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
						...
						<div class="accordion-list">
							<ul>
								<li>
									<a data-bs-toggle="collapse" class="collapse" data-bs-target="#accordion-list-1"><span>01</span> Integrity <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
									<div id="accordion-list-1" class="collapse show" data-bs-parent=".accordion-list">
										<p>
											We will deliver our promise of
											exceptional dedication with
											professional due care and
											ethical standards.
										</p>
									</div>
								</li>
								...
								<li>
									<a data-bs-toggle="collapse" data-bs-target="#accordion-list-2" class="collapsed"><span>02</span> Advancement <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
									<div id="accordion-list-2" class="collapse" data-bs-parent=".accordion-list">
										<p>
											We will ensure our excellence by improving
											the capabilities of our employees and clients
											through continuously upgrading our teams
											potential by on-the- job training, mentoring
											and acting upon our clients feedback.
										</p>
									</div>
								</li>
				...
				<div class="row">
					<div class="col text-center" style="text-align: center;">
						<p style="font-size: larger;">
							"We aim to be the best at helping clients achieve their goals and make a positive impact on society. 
							With hard work and more commitment, we are constantly evolving to make a real difference to every service we provide.
							We help clients to achieve extraordinary goals, solve complex problems, and make meaningful progress. 
