...
<body>
				...
				<ul>
					...
					<li class="dropdown"><a href="#"><span>Bahasa</span> <i class="bi bi-chevron-down"></i></a>
						<ul>
							...
							<li><a href="layanan-penasihat_investasi">Bahasa Indonesia</a></li>
						</ul>
					</li>
    ...
    <main id="main">
        <section id="services" class="services section-bg">
            <div class="container">
                <h1 style="text-align: center; font-weight: bolder; color: #37517e;">Penasihat Investasi & Studi Kelayakan</h1><br>
            </div>
            <div class="container">
                <p>
                    Kami menyediakan konsultasi tentang pendirian entitas baru di Indonesia. Memasuki pasar baru, memperkenalkan produk/layanan baru dan menargetkan segmen konsumen baru sangat diperlukan studi kelayakan yang menyeluruh. Ini harus mencakup faktor makro & mikro yang mempengaruhi keputusan manajemen. Namun, dunia bisnis saat ini terkenal dengan melimpahnya data, ini membuat pencarian dan penggunaan informasi yang dibutuhkan hampir tidak mungkin. Sangat penting bagi organisasi untuk mengambil keputusan yang tepat untuk mengoptimalkan alokasi sumber dayanya. Kami menyediakan klien kami dengan studi pasar analitik berikut untuk membantu mereka memanfaatkan sumber daya dan upaya mereka di tingkat tertinggi menggunakan data primer dan sekunder sesuai kebutuhan. <br><br>
            ...
            <div class="container">
                <div class="row">
					...
					<div class="col-5">
						<h4>Layanan Penasihat Investasi</h4>
					</div>
					<div class="col-1" style="text-align: center;">
						<div class="dot">
							<h4>2</h4>
            ...
            <div class="container" style="padding-top: 25px;">
				<div class="row">
					...
					<div class="col-5">
						<h4>Studi Wawasan Konsumen dan Ritel</h4>
					</div>
				</div>
			</div>
        </section>
