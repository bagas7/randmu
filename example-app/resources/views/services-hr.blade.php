...
<body>
	...
	<main id="main">
        <section id="services" class="services section-bg">
            <div class="container">
                <h1 style="text-align: center; font-weight: bolder; color: #37517e;">HR solutions</h1><br>
            </div>
            <div class="container">
                <p>
                    In our strive to provide our clients with all the assistance they need to efficiently 
                    manage their business and focus on the value adding activities of their human capital, 
                    we provide the below HR solutions. We provide solutions to businesses to accommodate 
                    for the rising trend to outsource support activities to professionals with 
                    the experience and tools needed to get the job done. <br><br>

                    To keep practitioners on the edge of these fields, we provide the following services:
                </p><br>
            </div>
            <div class="container">
                <div class="row">
					...
					<div class="col-5">
						<h4>Human Resources Administrative Support and Outsourcing</h4>
					</div>
                </div>
            </div>
