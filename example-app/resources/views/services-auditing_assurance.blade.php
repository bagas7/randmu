...
<body>
	...
	<main id="main">
        <section id="services" class="services section-bg">
            <div class="container">
                <h1 style="text-align: center; font-weight: bolder; color: #37517e;">Auditing & Assurance</h1><br>
            </div>
            <div class="container">
                <p>
                    In today's business environment, there is more scrutiny and skepticism of a company's financial statements than ever before and therefore auditing financial statements has become indispensable. Investors have lost faith in corporate governance and reporting.
                    <br><br>

                    Corporate management, boards and audit committees, internal and external auditors, analysts and other investment professionals all have important roles to play in rebuilding investor trust. Meeting investor expectations begins with the completeness and accuracy of the information provided in a company's financial statements.  
                    <br><br>
            ...
            <div class="container">
                <div class="row">
					...
					<div class="col-5">
                        ...
                        <p>
                            - Annual financial statements audit<br>
					...
					<div class="col-5">
						<h4>Financial Statements Review</h4>
                        <p>
                            - Annual financial statements review<br>
			...
			<div class="container" style="padding-top: 25px;">
				<div class="row">
					...
					<div class="col-5">
						<h4>Foreign Reporting</h4>
                        <p>
                            - Financial statements' translation<br>
                            - IFRS reporting<br>
